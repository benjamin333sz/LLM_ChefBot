...
def build_agent() -> CodeAgent:
    ...
    return CodeAgent(
        ...
        instructions=(
            ...
            "IMPORTANT: Le menu_database accepte:\n"
            "- category: entrée/plat/dessert/boisson (ou 'all' pour ne pas filtrer)\n"
            "- tags: vegetarien, vegan, sans_gluten\n"
            "- allergens: gluten, lait, œuf, soja, arachide\n"
            "Règles:\n"
            "- Utilise menu_database pour chercher des options adaptées.\n"
            "- Propose un MENU COMPLET pour 3 personnes (entrée + plat + dessert, boisson optionnelle).\n"
            "- 1 personne végétarienne => tag 'vegetarien' (ou 'vegan' ok si souhaité)\n"
            "- 1 personne sans gluten => exclude_allergens=['gluten'] OU tag 'sans_gluten'\n"
            "- 1 personne sans contrainte => n'importe.\n"
            "- Budget groupe max 60€: calcule le total avec calculate.\n"
            "- Donne une addition détaillée.\n"
        ),
    )
